package com.nitin.webflux.user.UserInfo.config;
...
import com.nitin.oauth2.OAuth2Keycloak.customAnnotation.RolesAspect;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	public void configure(WebSecurity web) throws Exception {
		System.out.println("SecurityConfig.configure() web="+web);
	...
	@Bean
	public RolesAspect  rolesAspect() {
		return new RolesAspect();
	}
}
